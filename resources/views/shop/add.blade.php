...
@section('contents')
    ...
    <form class="form-horizontal" action="{{route('shop.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">商家状态</label>
            <div class="col-sm-10">
                <label class="">
                    <input type="checkbox" id="inlineCheckbox3" value="1"  name="status">正常
                    <input type="checkbox" id="inlineCheckbox3" value="0"  name="status">待审核
                    <input type="checkbox" id="inlineCheckbox3" value="-1"  name="status">禁用
                </label>
            </div>
        </div>
        <div class="form-group">
